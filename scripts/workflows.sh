...
# Ports merobox uses for default 2/3-node setups plus the mero-calendar dev ports.
# Anything bound here will break container init — kill the holder before starting.
PORTS_TO_FREE=(2428 2429 2528 2529 2430 2431 2530 2531 2470 2471 2570 2571)
